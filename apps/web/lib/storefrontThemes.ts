...
function buildThemeCssVars({
  ...
  return {
    '--creator portal-text': text,
    '--creator portal-muted': withAlpha(text, 0.66),
    '--creator portal-subtle': withAlpha(text, 0.82),
    '--creator portal-border': withAlpha(text, 0.14),
    '--creator portal-soft-bg': softSurface,
    '--creator portal-chip-bg': withAlpha(chip, 0.16),
    '--creator portal-chip-text': withAlpha(text, 0.8),
    '--creator portal-nav-bg': `linear-gradient(180deg, ${withAlpha(nav, 0.92)}, ${withAlpha(nav, 0.86)})`,
    '--creator portal-panel-bg': `linear-gradient(180deg, ${panelTop}, ${panelBottom}), radial-gradient(circle at top left, ${withAlpha(glow, 0.18)}, transparent 36%)`,
    '--creator portal-card-bg': `linear-gradient(180deg, ${cardTop}, ${cardBottom}), linear-gradient(135deg, rgba(255,255,255,0.34), transparent 62%)`,
    '--creator portal-page-bg': `linear-gradient(180deg, ${withAlpha(panelTop, 0.9)} 0%, ${withAlpha(panelBottom, 0.92)} 42%, ${withAlpha(cardBottom, 0.96)} 100%)`,
  }
}
...
export const STOREFRONT_THEMES: StorefrontThemeDefinition[] = [
  ...
  },
  {
    ...
    subheadline: 'Built for backpacking creators who want their creator portal to feel like a living notebook.',
    chip: 'Backpacking',
    pageClassName: 'editorial-shell text-[#17332d]',
    shellClassName: 'creator portal-panel',
  ...
  },
  {
    ...
    headline: 'The city guide creator portal for the audience that wants your exact itinerary.',
  ...
  },
  {
    ...
    headline: 'Every meal, market, and must-order dish mapped into one creator portal.',
